...
type CardLabLine = "main-sandbox" | "before-the-glory";
...
const holoVariantCards: Array<{
  ...
  { id: "frame-soft", label: "Holo V4", description: "Cleaner edge frame" },
...
export const CardLabPage = () => {
  ...
  const beforeTheGloryPreviewScale = Math.min(cardScale * 0.5, 0.62);
  const beforeTheGloryCardWidth = Math.round(388 * beforeTheGloryPreviewScale);
  const beforeTheGloryCardHeight = Math.round(930 * beforeTheGloryPreviewScale);
              ...
              <div className="mt-5 space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className={`${controlButtonClass} ${holo ? "border-sky-300/40 bg-sky-300/16 text-sky-100" : "border-white/12 bg-white/6 text-slate-300 hover:bg-white/10"}`}
                    >
                      Holo
                    </button>
                  </div>
                        ...
                        <div className="flex flex-wrap justify-center gap-6">
                          {section.cards.map((card) => (
                            <div
                              ...
                              style={{ width: `${beforeTheGloryCardWidth}px`, maxWidth: "100%" }}
                            >
                              ...
                              <div
                                ...
                                style={{
                                  width: `${beforeTheGloryCardWidth}px`,
                                  height: `${beforeTheGloryCardHeight}px`,
                                  maxWidth: "100%",
                                }}
                              >
                                <div
                                  ...
                                  style={{
                                    transform: `scale(${beforeTheGloryPreviewScale})`,
