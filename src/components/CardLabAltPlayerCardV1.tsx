...
const tierSurfaceStyles: Record<LabRarity, string> = {
  S: "before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.26),transparent_34%),linear-gradient(135deg,rgba(251,191,36,0.1),transparent_42%,rgba(249,115,22,0.12))]",
  A: "before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_top,rgba(56,189,248,0.22),transparent_34%),linear-gradient(135deg,rgba(56,189,248,0.08),transparent_42%,rgba(59,130,246,0.12))]",
  B: "before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.2),transparent_34%),linear-gradient(135deg,rgba(168,85,247,0.08),transparent_42%,rgba(79,70,229,0.12))]",
  C: "before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.2),transparent_34%),linear-gradient(135deg,rgba(16,185,129,0.08),transparent_42%,rgba(6,182,212,0.1))]",
  ...
  Galaxy:
    "before:absolute before:inset-0 before:bg-[linear-gradient(180deg,rgba(2,6,23,0.22),rgba(2,6,23,0.7)),url('https://4kwallpapers.com/images/wallpapers/galaxy-milky-way-stars-deep-space-colorful-astronomy-nebula-2880x1800-5366.jpg')] before:bg-cover before:bg-center",
  "Pink Smoke":
    "before:absolute before:inset-0 before:bg-[linear-gradient(180deg,rgba(24,4,22,0.18),rgba(24,4,22,0.62)),url('https://california-wallpaper.com/cdn/shop/products/il_fullxfull.3329965225_tq31.jpg?v=1657242849&width=1080')] before:bg-cover before:bg-center",
  "Neon Paint":
    "before:absolute before:inset-0 before:bg-[linear-gradient(180deg,rgba(4,10,24,0.14),rgba(4,10,24,0.58)),url('https://4kwallpapers.com/images/wallpapers/abstract-art-3840x2160-23159.jpg')] before:bg-cover before:bg-center",
  "Black/Gold Marble":
    "before:absolute before:inset-0 before:bg-[linear-gradient(180deg,rgba(8,6,2,0.14),rgba(8,6,2,0.64)),url('https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDI1LTA3L3Jhd3BpeGVsb2ZmaWNlOF9ibGFja19tYXJibGVfdGV4dHVyZV93YWxscGFwZXJfZGFya192ZWluZWRfc3Rvbl83ODVlZTg4NC02MDQ4LTQ5NDYtYWY0My1mODljZGU2YmYwZTlfMS5qcGc.jpg')] before:bg-cover before:bg-center",
  Amethyst:
    "before:absolute before:inset-0 before:bg-[linear-gradient(180deg,rgba(18,6,34,0.14),rgba(18,6,34,0.62)),url('https://wallpapercat.com/w/full/0/9/a/2306286-2500x1149-desktop-dual-monitors-amethyst-wallpaper.jpg')] before:bg-cover before:bg-center",
  Emerald:
    "before:absolute before:inset-0 before:bg-[linear-gradient(180deg,rgba(4,20,14,0.14),rgba(4,20,14,0.62)),url('https://img.pikbest.com/origin/10/12/95/17TpIkbEsTGgn.jpg!w700wp')] before:bg-cover before:bg-center",
  Ruby:
    "before:absolute before:inset-0 before:bg-[linear-gradient(180deg,rgba(34,6,10,0.14),rgba(34,6,10,0.62)),url('https://images2.alphacoders.com/134/1340326.png')] before:bg-cover before:bg-center",
  Sapphire:
    "before:absolute before:inset-0 before:bg-[linear-gradient(180deg,rgba(5,16,36,0.14),rgba(5,16,36,0.62)),url('https://img.freepik.com/free-photo/close-up-glitter-decoration-detail_23-2149048284.jpg')] before:bg-cover before:bg-center",
};

const getLabRarityShellClass = (rarity: LabRarity) =>
  rarity === "Galaxy"
    ? "border-fuchsia-200/35 shadow-[0_22px_50px_rgba(168,85,247,0.18)]"
    : rarity === "Pink Smoke"
      ? "border-pink-200/35 shadow-[0_22px_50px_rgba(244,114,182,0.2)]"
      : rarity === "Neon Paint"
        ? "border-cyan-200/35 shadow-[0_22px_50px_rgba(34,211,238,0.24)]"
        : rarity === "Black/Gold Marble"
          ? "border-amber-200/38 shadow-[0_22px_50px_rgba(251,191,36,0.22)]"
          : rarity === "Amethyst"
            ? "border-violet-200/38 shadow-[0_22px_50px_rgba(192,132,252,0.22)]"
            : rarity === "Emerald"
              ? "border-emerald-200/38 shadow-[0_22px_50px_rgba(52,211,153,0.22)]"
              : rarity === "Ruby"
                ? "border-rose-200/38 shadow-[0_22px_50px_rgba(251,113,133,0.22)]"
                : rarity === "Sapphire"
                  ? "border-sky-200/38 shadow-[0_22px_50px_rgba(56,189,248,0.22)]"
...
interface CardLabAltPlayerCardV1Props {
  player: Player;
  selected?: boolean;
  upgraded?: boolean;
  compact?: boolean;
  ...
  return (
    <div
      className={clsx(
        ...
        compact ? "min-h-[420px] p-4" : "min-h-[860px] p-5",
      ...
      <div className="relative flex h-full flex-col">
        <div className="grid grid-cols-[auto_1fr_auto] items-start gap-3">
          ...
          <div className="flex justify-center pt-1">
            {team?.logo ? (
              <div className={clsx("flex items-center justify-center rounded-[22px] border border-white/12 bg-white/95 shadow-[0_12px_28px_rgba(0,0,0,0.16)]", compact ? "h-16 w-16 p-3" : "h-24 w-24 p-4")}>
                <img
                  src={team.logo}
                  alt={`${team.name} logo`}
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 h-[18%] bg-gradient-to-t from-slate-950/70 via-slate-950/35 to-transparent" />
        </div>

        <div className={clsx("mt-4 text-center", compact ? "px-2 py-1" : "px-3 py-1")}>
          <div
            className={clsx(
              "font-display font-semibold leading-none tracking-tight text-white whitespace-nowrap",
              nameClassName,
            )}
          >
            {fullName}
        ...
        <div className={clsx("mt-4", compact ? "px-2 py-2" : "mt-auto px-2 py-2")}>
          <PlayerTypeBadges
            player={player}
            compact
            iconOnly
