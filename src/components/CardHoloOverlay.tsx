      ...
      case "frame-soft":
        return (
          <>
            ...
            <div className="absolute inset-0 rounded-[inherit] shadow-[inset_0_0_0_2px_rgba(255,255,255,0.2),inset_0_0_0_5px_rgba(255,0,170,0.12),inset_0_0_0_9px_rgba(56,189,248,0.08),inset_0_0_34px_rgba(56,189,248,0.2),inset_0_0_62px_rgba(250,204,21,0.12)]" />
            <div className="absolute inset-[2px] rounded-[inherit] opacity-[0.96] bg-[linear-gradient(135deg,rgba(255,0,170,0.3)_0%,transparent_16%,transparent_74%,rgba(45,212,191,0.24)_86%,rgba(250,204,21,0.3)_100%)]" />
            <div className="absolute inset-[6px] rounded-[inherit] opacity-[0.72] mix-blend-screen shadow-[inset_0_0_0_1px_rgba(255,255,255,0.34),inset_0_0_18px_rgba(255,255,255,0.08),inset_0_0_28px_rgba(45,212,191,0.16)]" />
            <div className="absolute inset-0 opacity-[0.56] mix-blend-color-dodge bg-[linear-gradient(90deg,rgba(255,255,255,0.24)_0%,rgba(255,0,170,0.2)_3%,transparent_12%,transparent_88%,rgba(56,189,248,0.22)_97%,rgba(255,255,255,0.24)_100%),linear-gradient(180deg,rgba(255,255,255,0.22)_0%,rgba(250,204,21,0.16)_3%,transparent_13%,transparent_87%,rgba(45,212,191,0.18)_97%,rgba(255,255,255,0.22)_100%)]" />
