...
export const dynamicDuos: PlayerBadgeDefinition[] = [
  ...
  { id: "harden-cp3-rockets", title: "Dynamic Duos: James Harden (Rockets) + Chris Paul (Rockets)", type: "dynamic-duo", players: ["james-harden-rockets", "chris-paul-rockets"] },
  ...
  { id: "luka-kyrie-mavs", title: "Dynamic Duos: Luka Doncic (Mavs) + Kyrie Irving (Mavs)", type: "dynamic-duo", players: ["luka-doncic-mavs", "kyrie-irving-mavs"] },
...
export const teamChemistryGroups: TeamChemistryGroupDefinition[] = [
  ...
  },
  {
    ...
    displayName: "Team Chemistry: Kobe Lakers",
    teamName: "Los Angeles Lakers",
    season: "2008-2010",
    nickname: "Kobe Lakers",
    eligiblePlayers: [
      "kobe-bryant-24",
      "pau-gasol",
      "lamar-odom",
  ...
  {
    id: "cavs-2007-finals",
    displayName: "Team Chemistry: 2007 Finals Cavs",
    teamName: "Cleveland Cavaliers",
    season: "2006-07",
    nickname: "2007 Finals Cavs",
    eligiblePlayers: [
      "lebron-james-03-10",
      "larry-hughes",
      "zydrunas-ilgauskas",
  ...
  {
    id: "pacers-2000-finals",
    displayName: "Team Chemistry: 2000 Finals Pacers",
    teamName: "Indiana Pacers",
    season: "1999-2000",
    nickname: "2000 Finals Pacers",
    eligiblePlayers: [
      "reggie-miller",
      "mark-jackson",
      "rik-smits",
  ...
  {
    id: "celtics-1963-champs",
    displayName: "Team Chemistry: 63 Champs Celtics",
    teamName: "Boston Celtics",
    season: "1962-63",
    nickname: "63 Champs Celtics",
    eligiblePlayers: [
      "bob-cousy",
      "bill-russell",
      "john-havlicek",
